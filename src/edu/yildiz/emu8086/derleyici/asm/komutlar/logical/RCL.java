 ...
 * @author MMC
 */
public class RCL extends CiftOperandliKomut
{
    public RCL(ByteRegisterOperand sol, ByteRegisterOperand sag) throws ParserException
    {
        super(sol, sag);
    ...
    public RCL(ByteRegisterOperand sol, ByteImmediateOperand sag)
    {
        super(sol, sag);
    ...
    public RCL(WordRegisterOperand sol, ByteRegisterOperand sag) throws ParserException
    {
        super(sol, sag);
    ...
    public RCL(WordRegisterOperand sol, ByteImmediateOperand sag)
    {
        super(sol, sag);
    ...
    public RCL(MemoryOperand sol, ByteRegisterOperand sag) throws ParserException
    {
        super(sol, sag);
    ...
    public RCL(MemoryOperand sol, ByteImmediateOperand sag)
    {
        super(sol, sag);
    ...
    {
        super.aluIslemiEkle(AluIslemi.Tur.RCL, VeriUzunlugu.Byte_8, sol, sag);
