 ...
 * @author MMC
 */
public class JS extends TekOperandliKomut
{
    public JS(EtiketOperand hedef)
    {
        super(hedef);
        
        AtlamaIslemi islem = new AtlamaIslemi(hedef);
        islem.kosulEkle(new FlagOperand(FlagRegister.Tur.SIGN), AtlamaIslemi.Operator.ESIT, (byte)1);
