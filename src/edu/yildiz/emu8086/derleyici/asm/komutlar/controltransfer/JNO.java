 ...
 * @author MMC
 */
public class JNO extends TekOperandliKomut
{
    public JNO(EtiketOperand hedef)
    {
        super(hedef);
               
        AtlamaIslemi islem = new AtlamaIslemi(hedef);
        islem.kosulEkle(new FlagOperand(FlagRegister.Tur.OVERFLOW), AtlamaIslemi.Operator.ESIT, (byte)0);
